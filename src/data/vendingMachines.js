export const vendingMachines = [
    ...
    { 
      ...
      products: ['Coca Cola', 'Diet Coke', 'Water', 'Sprite', 'Dr. Pepper', 'Lays Classic', 'Fritos Twists', 'Doritos Nacho Cheese', 'Sun Chips Harvest Cheddar', "Miss Vickie's Spicy Dill Pickle Chips", 'Doritos Cool Ranch', 'Smartfood White Cheddar Popcorn', 'Ruffles Cheddar & Sour Cream', 'Lays Sour Cream & Onion', 'Lays Salt & Vinegar', 'Gardettos Snack Mix', 'Cheez It', 'Classic Cookie', 'Big Honey Bun', 'Nerds Gummy Clusters', 'Mike&Ike', 'Peanut Butter Crackers', 'Toasted Cheese Peanut Butter Crackers', 'Skittles', "Reese's Peanut Butter Cups", 'Kinder Bueno', 'Peanut M&Ms', 'KitKat', "Reese's Sticks", 'Rice Krispies Treats', 'Nature Valley Cinnamon Almond Butter Biscuits', 'Snickers', 'Clif Bar Chocolate Chip', 'Nature Valley Granola Bar', 'Crunch'] 
    },
    { 
      id: 12, 
