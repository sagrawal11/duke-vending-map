export const vendingMachines = [
    ...
    { 
      ...
      products: ['Coca Cola', 'Diet Coke', 'Water', 'Sprite', 'Dr. Pepper', 'Lays Classic', 'Fritos Twists', 'Doritos Nacho Cheese', 'Sun Chips Harvest Cheddar', 'Miss Vickies Spicy Dill Pickle Chips', 'Doritos Cool Ranch', 'Smartfood White Cheddar Popcorn', 'Ruffles Cheddar & Sour Cream', 'Lays Sour Cream & Onion', 'Lays Salt & Vinegar', 'Gardettos Snack Mix', 'Cheez It', 'Classic Cookie', 'Big Honey Bun', 'Nerds Gummy Clusters', 'Mike&Ike', 'Peanut Butter Crackers', 'Toasted Cheese Peanut Butter Crackers', 'Skittles', "Reese's Peanut Butter Cups", 'Kinder Bueno', 'Peanut M&Ms', 'KitKat', "Reese's Sticks", 'Rice Krispies Treats', 'Nature Valley Cinnamon Almond Butter Biscuits', 'Snickers', 'Clif Bar Chocolate Chip', 'Nature Valley Granola Bar', 'Crunch'] 
    },
    { 
      id: 12, 
    ...
    { 
      ...
      products: ['Coca Cola', 'Diet Coke', 'Sprite', 'Mellow Yellow', 'Dr. Pepper', 'Diet Dr. Pepper', 'Lemonade', 'Lays Classic', 'Fritos Twists', 'Doritos Nacho Cheese', 'Sun Chips Garden Salsa', 'Lays Barbeque', 'Miss Vickies Spicy Dill Pickle Chips', 'Bugles Nacho Cheese', 'Ruffles Cheddar & Sour Cream', 'Popchips Sea Salt', 'Mini Pretzels', 'Cheetos', 'Smartfood White Cheddar Popcorn', 'Cheez It', 'Goldfish', 'Mini Cookies', 'Mike&Ike', 'Big Honey Bun', 'Black Forest Fruit Snacks', 'Sour Skittles Gummies', 'Grilled Cheese Crackers', 'Skittles', 'Toasted Cheese Peanut Butter Crackers', 'Peanut Butter Crackers', 'Rice Krispies Treats', "Reese's Peanut Butter Cups", 'Nutra Grain', 'Ghirardelli Milk Chocolate Caramel', 'Snickers', 'M&Ms', 'KitKat', 'Clif Bar Chocolate Chip', 'Peanut M&Ms', "Reese's Sticks", 'Trail Mix', 'Gatorade Protein Bar', 'Nature Valley Granola Bar'] 
    },
    { 
      id: 21, 
    ...
    { 
      ...
      products: ['Lays Classic', 'Fritos Twists', 'Doritos Nacho Cheese', 'Smartfood White Cheddar Popcorn', 'Lays Barbeque', 'Ruffles Cheddar & Sour Cream', 'Lays Sour Cream & Onion', 'Fritos Original', 'Mini Pretzels', 'Pop Tarts', 'Sun Chips Harvest Cheddar', 'Gardettos Snack Mix', 'Cheez It', 'Miss Vickies Spicy Dill Pickle Chips', 'Grilled Cheese Crackers', 'Gushers', 'Toasted Cheese Peanut Butter Crackers', 'Peanut Butter Crackers', 'Trail Mix', 'Airheads Bites', 'Crunch', "Reese's Sticks", 'Peanut M&Ms', 'Snickers', 'KitKat', 'M&Ms', "Reese's Peanut Butter Cups", 'Gatorade Protein Bar', 'Rice Krispies Treats', 'Slim Jim', 'Nature Valley Almond Butter Biscuits', 'Skittles Gummies', 'Sour Skittles Gummies', 'Beef Tender Bites', 'Gushers', 'Mike&Ike', 'Coca Cola', 'Diet Coke', 'Sprite', 'Lemonade', 'Diet Dr. Pepper', 'Dr. Pepper', 'Fanta', 'Water', 'Vitamin Water'] 
    },
    { 
      id: 25, 
    ...
    { 
      ...
      products: ['Coca Cola', 'Sprite', 'Seagrams Ginger Ale', 'Dr. Pepper', 'Diet Coke', 'Water', 'Pepsi', 'Diet Pepsi', 'Mountain Dew', 'Diet Mountain Dew', 'Lays Classic', 'Fritos Twists', 'Doritos Nacho Cheese', 'Bugles Nacho Cheese', 'Fritos Original', 'Ruffles Cheddar & Sour Cream', 'Mini Pretzels', 'Pop Tarts', 'Cheez It', 'Miss Vickies Spicy Dill Pickle Chips', 'Sour Skittles Gummies', 'Big Honey Bun', 'Gatorade Protein Bar', 'Mini Cookies', 'Beef Tender Bites', 'Gushers', 'Toasted Cheese Peanut Butter Crackers', 'Peanut Butter Crackers', 'Snickers', 'Peanut M&Ms', 'Ghirardelli Milk Chocolate Caramel', 'Slim Jim', 'Crunch', 'Nature Valley Granola Bar'] 
    },
    { 
      id: 29, 
